...
contextBridge.exposeInMainWorld('api', {
  ...
  enterpriseList: () => ipcRenderer.invoke('enterprise:list'),
  enterpriseSaveConfig: (enterprise) => ipcRenderer.invoke('enterprise:save-config', enterprise || {}),
  enterpriseCreateRole: (role) => ipcRenderer.invoke('enterprise:roles:create', role || {}),
  enterpriseUpdateRole: (id, patch) => ipcRenderer.invoke('enterprise:roles:update', { id, patch: patch || {} }),
  enterpriseDeleteRole: (id) => ipcRenderer.invoke('enterprise:roles:delete', id),
  enterpriseCreateOperator: (operator) => ipcRenderer.invoke('enterprise:operators:create', operator || {}),
  ...
  wsServerCreateSessionInvite: (payload) => ipcRenderer.invoke('ws-server:create-session-invite', payload || {}),
  lanTunnelStart: () => ipcRenderer.invoke('lan-tunnel:start'),
  lanTunnelStop: () => ipcRenderer.invoke('lan-tunnel:stop'),
  ...
  whatsapp: {
    ...
    getQR: () => ipcRenderer.invoke('whatsapp:get-qr'),
    kbList: () => ipcRenderer.invoke('whatsapp:kb-list'),
    kbGet: (id) => ipcRenderer.invoke('whatsapp:kb-get', id),
    kbSave: (payload) => ipcRenderer.invoke('whatsapp:kb-save', payload),
    kbDelete: (id) => ipcRenderer.invoke('whatsapp:kb-delete', id),
